  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        {(!process.env.NEXT_PUBLIC_SUPABASE_URL || process.env.NEXT_PUBLIC_SUPABASE_URL === 'https://placeholder.supabase.co' || !process.env.OPENAI_API_KEY) && (
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-yellow-700 text-sm mb-2">
                  Для полной функциональности настройте переменные окружения в Vercel:
                </p>
                <ul className="text-yellow-700 text-sm space-y-1">
                  {(!process.env.NEXT_PUBLIC_SUPABASE_URL || process.env.NEXT_PUBLIC_SUPABASE_URL === 'https://placeholder.supabase.co') && (
                    <li>• NEXT_PUBLIC_SUPABASE_URL и NEXT_PUBLIC_SUPABASE_ANON_KEY</li>
                  )}
